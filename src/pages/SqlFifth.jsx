        ...
        <div className="application" style={{ width: '400px', height: '300px', padding: '20px', border: '1px solid #ccc', borderRadius: '5px', backgroundColor: '#fff', top: '30px' }}>
          ...
          <form id="login-form" action="#" method="post" onSubmit={handleSubmit} style={{ width: 'calc(100% - 20px)', position: 'relative' }}>
            <div style={{ position: 'relative' }}>
              <input type="text" id="username" name="username" placeholder="example@email.com" value="user@email.com" style={{ width: 'calc(100% - 20px)', padding: '10px', marginBottom: '10px', border: '1px solid #ccc', borderRadius: '5px'}} readOnly />
              {showErrorMessage && (
            ...
            <input type="password" id="password" name="password" placeholder="password" style={{ width: 'calc(100% - 20px)', padding: '10px', marginBottom: '10px', border: '1px solid #ccc', borderRadius: '5px', fontFamily: 'monospace' }} readOnly />
      ...
      <div className="code-body" style={{ height: 'calc(100% - 40px)', overflowY: 'auto', padding: '10px', backgroundColor: '#000', border: '1px solid #ccc', borderRadius: '5px', color: '#fff' }}>
        <pre style={{ margin: 0 }}>
          <code style={{ color: '#fff' }}>
            SELECT * <br />
            FROM users <br />
            WHERE email = <span style={{ color: '#ccc' }}>'user@email.com'</span> <br />
            AND pass  = ''
          </code>
        </pre>
      </div>
...
<div className="footer" style={{ width: '250px', height: '160px', backgroundColor: 'white', border: '2px solid black', position: 'absolute', bottom: '162.5px', display: 'flex', alignItems: 'center', justifyContent: 'center', left: 'calc(50% - 100px - 300px - 300px + 120px)' }}>
<span className="footer-text" style={{ color: 'black', textAlign: 'center' }}>
  ...
  <button onClick={() => navigate('/SqlSixth')}>Next</button>
</span>
</div>
</div>
);
