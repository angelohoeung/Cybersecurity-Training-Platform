...
const SqlFourth = ({ token }) => {
  ...
  return (
    <div style={{ marginTop: '12.5px' }}>
      ...
      <div className="footer" style={{ width: '220px', height: '200px', backgroundColor: 'white', border: '2px solid black', position: 'absolute', bottom: '162.5px', display: 'flex', alignItems: 'center', justifyContent: 'center', left: 'calc(50% - 100px - 300px - 300px + 150px)' }}>
        ...
        <p>
          ...
          <button onClick={() => navigate('/SqlFifth')}>Next</button>
        </span>
      </div>
    </div>
  );
